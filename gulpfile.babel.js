'use strict'
const projectName = 'timegulp.loc'
/****************************************************************************************************/
//MODULES REQUIRE
/****************************************************************************************************/
...
task('img', () =>
  src(['src/img/**/*.{jpg,png,gif}', 'src/images/**/*.{jpg,png,gif}'], {base: 'src'})
    ...
    .pipe(gulpIf(isDevelopment, symlink(cms.modx.img), dest(cms.modx.img)))
)
/****************************************************************************************************/
//SVG task
/****************************************************************************************************/
...
task('favicon', () =>
  src('src/favicon.ico')
    .pipe(gulpIf(!isDevelopment, dest(cms.modx.html), symlink(cms.modx.html)))
)
/****************************************************************************************************/
//WATCHERS
/****************************************************************************************************/
